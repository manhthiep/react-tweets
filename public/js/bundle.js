...
},{"./components/TweetsApp.react":7,"react":154}],2:[function(require,module,exports){
/** @jsx React.DOM */
      ...
      return (
        React.DOM.li({className: "tweet" + (tweet.active ? ' active' : '')}, 
          ...
          React.DOM.blockquote(null, 
            React.DOM.cite(null, 
              React.DOM.a({href: "https://www.twitter.com/" + tweet.screenname, target: "_blank"}, tweet.author), 
              React.DOM.span({className: "screen-name"}, "@", tweet.screenname), 
              React.DOM.span({className: "separator"}, " - "), 
              React.DOM.span({className: "time-from-now"}, 
                React.DOM.a({href: "https://www.twitter.com/" + tweet.screenname + "/status/" + tweet.twid, 
                  target: "_blank"}, 
                  React.DOM.span({className: "date-time", 'data-date-time': "" + tweet.date}, time_from_now), " ", React.DOM.span(null, "on Twitter")
                )
              )
            ), 
...
},{"autolinker":8,"moment":10,"react":154}],6:[function(require,module,exports){
/** @jsx React.DOM */
...
},{"./Tweet.react.js":5,"react":154}],7:[function(require,module,exports){
/** @jsx React.DOM */
...
},{"./Loader.react.js":2,"./NotificationBar.react.js":3,"./TopBar.react.js":4,"./Tweets.react.js":6,"react":154}],8:[function(require,module,exports){
